...
import { types, IMSTMap, ISimpleType, IAnyModelType } from 'mobx-state-tree';
import { JSONSchemaBase } from '@toryjs/form';

import { SchemaRecord } from './editor_types';
import { root, findParentSchema } from './editor_common';
import { elementSchema, schemaSchema, boundSchema } from './common_schemas';
import { toJS } from 'mobx';
import { schemaDatasetToJS, ls } from '../helpers';
  ...
  const stateStore = types
    ...
    .actions(self => ({
      ...
      setElement(element: FormDataSet, schema: SchemaDataSet) {
        ...
        context.selectedParentSchema = findParentSchema(
          element,
          schema,
          context as DynamicForm.EditorContextType
        );
      },
