...
type SchemaHandler = Handler<SchemaDataSet, EditorContextType>;
type SchemaParseHandler = ParseHandler<SchemaDataSet, EditorContextType>;
type SchemaValidateHandler = ValidateHandler<SchemaDataSet, EditorContextType>;
...
export const titleValueHandler: SchemaHandler = ({ owner, context }) =>
  owner.title == null ? context.project.state.selectedSchemaName : owner.title;

export const titleParseHandler: SchemaParseHandler = ({ context, args }) =>
  context.project.renameSchema(args.current, context.schema);
...
export const requiredParse: SchemaParseHandler = ({ args, context }) => {
  if (args.current) {
    ...
    context.selectedParentSchema.removeRowData(
      'required',
