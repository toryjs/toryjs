...
import { formDatasetToJS, schemaDatasetToJS } from '@toryjs/ui';
...
export const ModalCode: React.FC = () => {
  ...
  const schema = context.editor.schema ? schemaDatasetToJS(context.editor.schema) : null;
  const form = context.editor.form ? formDatasetToJS(context.editor.form) : null;
